...
IFRS17Module13UI<- function(id) {
  ...
  tagList(
    div(
      ...
      h2("📘 Module 13 – Presentation in the Statement of Financial Position", class = "diagram-title"),
      p("IFRS 17 requires insurance companies to show insurance and reinsurance contracts separately in their financial statements. In the balance sheet (statement of financial position), insurers must clearly show:"),
      tags$ul(
    ...
    div(
      ...
      img(src = "images/statement_of_financial_position.png", class = "financial-position-img")
    ),
    ...
    div(
      ...
      img(src = "images/IFRS4vsIFRS17BalanceSheet.png", class = "balance-sheet-img")
    ),

    div(
      class = "centered-footer-box",
      div(
    ...
    box(
        title = "Answer the following questions to test your understanding of Presentation in the Statement of Financial Position.",
